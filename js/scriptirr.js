...
function calcLinesIrr(affinity, efficacy, recepDensity, efficiency, agoaffinity, agoconcentration) {
    ...
    if (agoconcentration == 0) {
        ...
        for (i = -12; i < -2; i = i + STEP) {
            data[0].push(i);
            // Bit of both from client feedback? 
            // new formula implys removing  / affin from under 10^i 
            // but this does not produce favorable graphs
            // this will be replicated in schild page.
